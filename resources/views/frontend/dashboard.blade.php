                ...
                <div class="card card-stats">
                    <div class="card-body ">
                        <div class="row">
                            ...
                            <div class="col-7 col-md-8">
                                <div class="numbers">
                                    <p class="card-category">My Brands</p>
                                    <p class="card-title">{{number_format($data["countUserBrands"],0)}}<p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card card-stats">
                    <div class="card-body ">
                        <div class="row">
                            ...
                            <div class="col-7 col-md-8">
                                <div class="numbers">
                                    <p class="card-category">My Stores</p>
                                    <p class="card-title">{{number_format($data["countUserstores"],0)}}<p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-12">
                <div class="card ">
                    <div class="card-header ">
                        <h5 class="card-title">Brands & Stores</h5>
